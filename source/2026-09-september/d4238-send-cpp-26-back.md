...
[16] [P3173R0](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2024/p3173r0.pdf) - "P2900R6 may be minimal, but it is not viable" (Gabriel Dos Reis, 2024).

[17] [P3506R0](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/p3506r0.pdf) - "P2900 Is Still not Ready for C++26" (Gabriel Dos Reis, 2025).

[18] [P3573R0](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2025/p3573r0.pdf) - "Contract concerns" (Bjarne Stroustrup, Michael Hava, J. Daniel Garc&iacute;a S&aacute;nchez, Ran Regev, Gabriel Dos Reis, John Spicer, J.C. van Winkel, Daveed Vandevoorde, Ville Voutilainen, 2025).

[19] [cplusplus/papers issue 1901](https://github.com/cplusplus/papers/issues/1901#issuecomment-2991632817) - EWG Sofia poll record for P3100R2, posted by the EWG chair, 2025-06-20.

[20] [cplusplus/papers issue 1901](https://github.com/cplusplus/papers/issues/1901#issuecomment-4013380936) - EWG Croydon poll record for P3100R5, both polls, posted by the EWG vice-chair, 2026-03-26.

[21] [P3100R8](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2026/p3100r8.pdf) - "A framework for systematically addressing undefined behaviour in the C++ Standard" (Timur Doumler, Joshua Berne, 2026).

[22] [cplusplus/papers issue 1931](https://github.com/cplusplus/papers/issues/1931#issuecomment-2181419735) - SG21 telecon poll record of 2024-05-30 on the Contracts MVP ship vehicle, posted by the SG21 assistant chair, 2024-06-20.
